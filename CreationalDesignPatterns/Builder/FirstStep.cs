...
{
    // The String Builder is an .NET Framework built-in Builder which is used to build up Strings. It is a good starting poitn to familiarize yourself with the Builder concept.
